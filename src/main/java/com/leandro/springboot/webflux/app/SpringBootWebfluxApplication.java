package com.leandro.springboot.webflux.app;
...
public class SpringBootWebfluxApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Flux.just(new Producto("TV Panasonic", 456.89),
		new Producto("Sony Camara HD Digital", 177.89),
				new Producto("Apple iPod", 46.89),
				new Producto("Sony Notebook", 887.89),
				new Producto("Hewlett Packard Multifuncional", 200.89),
				new Producto("Bianchi Bicicleta", 77.89),
				new Producto("HP Notebook Omen 17", 2500.89),
				new Producto("Comoda 5 Cajone", 150.89),
				new Producto("TV Sony Bravia OLED 4K Ultra HD", 2250.89)
		)
				.flatMap(producto -> {
